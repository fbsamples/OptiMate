...
save_directory = 'C:/Users/user/Desktop/' # this is just an example on PC
...
# Use the Fetch_Interest_IDs.py to identify the ones you want to work on
# If not using interests, leave the list empty
interest_list = [[]] #6003332344237, #Example: Interest ID for Dogs
...
camp_objectives = ['BRAND_AWARENESS', 'VIDEO_VIEWS'] 

# Weekly frequency caps list to simulate
weekly_freq_caps = [2, 3] 
...
# Fetch today's date to make a call for the last 3 months as a reference
# This is needed to avoid passing the rate limit

until_date = datetime.now()
days_84 = timedelta(84)
since_date = until_date - days_84

# Define the variables that will be used on the get_insights endpoint
...
for country in countries:
                ...
                for objective in camp_objectives:
                    ...
                    for weekly_freq_cap in weekly_freq_caps:
                        ...
                        for days in camp_days:
                            ...
                            df_append_sim.loc[count, 'weekly_freq_cap'] = weekly_freq_cap
                            df_append_sim.loc[count, 'objective'] = objective
                            df_append_sim.loc[count, 'interests'] = ' '.join([str(elem) for elem in interests])
                            ...
                            if objective == 'POST_ENGAGEMENT':
                                ...
                                prediction = ad_account.create_reach_frequency_prediction(
                                    params={
                                        ...
                                        'frequency_cap': lifetime_freq_control,
                            ...
                            df_append_sim.loc[count, 'rf_reach_pct_bau_pred'] = df_append_sim.loc[count, 'rf_reach_bau_pred'] / max_reach
                        ...
                        ############------------------Simulations for +10 budget scenario------------------###################
                            ...
                            df_append_sim.loc[count, 'rf_reach_pct_10_pred'] = df_append_sim.loc[count, 'rf_reach_10_pred'] / max_reach
                            ...
                            df_append_sim.loc[count, 'rf_reach_pct_15_pred'] = df_append_sim.loc[count, 'rf_reach_15_pred'] / max_reach
                            ...
                            df_append_sim.loc[count, 'rf_reach_pct_20_pred'] = df_append_sim.loc[count, 'rf_reach_20_pred'] / max_reach
                            ...
                            df_append_sim.loc[count, 'rf_reach_pct_25_pred'] = df_append_sim.loc[count, 'rf_reach_25_pred'] / max_reach
                            ...
                            df_append_sim.loc[count, 'rf_reach_pct_30_pred'] = df_append_sim.loc[count, 'rf_reach_30_pred'] / max_reach
                            ...
                            df_append_sim.loc[count, 'rf_reach_pct_35_pred'] = df_append_sim.loc[count, 'rf_reach_35_pred'] / max_reach
                            ...
                            df_append_sim.loc[count, 'rf_reach_pct_40_pred'] = df_append_sim.loc[count, 'rf_reach_40_pred'] / max_reach
                            ...
                            df_append_sim.loc[count, 'rf_reach_pct_45_pred'] = df_append_sim.loc[count, 'rf_reach_45_pred'] / max_reach
                            ...
                            df_append_sim.loc[count, 'rf_reach_pct_50_pred'] = df_append_sim.loc[count, 'rf_reach_50_pred'] / max_reach
                            ...
                            df_append_sim.loc[count, 'rf_reach_pct_55_pred'] = df_append_sim.loc[count, 'rf_reach_55_pred'] / max_reach
                            ...
                            df_append_sim.loc[count, 'rf_reach_pct_60_pred'] = df_append_sim.loc[count, 'rf_reach_60_pred'] / max_reach
                            ...
                            df_append_sim.loc[count, 'rf_reach_pct_65_pred'] = df_append_sim.loc[count, 'rf_reach_65_pred'] / max_reach
                            ...
                            df_append_sim.loc[count, 'rf_reach_pct_70_pred'] = df_append_sim.loc[count, 'rf_reach_70_pred'] / max_reach
                            ...
                            df_append_sim.loc[count, 'rf_reach_pct_75_pred'] = df_append_sim.loc[count, 'rf_reach_75_pred'] / max_reach
                            ...
                            df_append_sim.loc[count, 'rf_reach_pct_80_pred'] = df_append_sim.loc[count, 'rf_reach_80_pred'] / max_reach
                            ...
                            df_append_sim.loc[count, 'rf_reach_pct_85_pred'] = df_append_sim.loc[count, 'rf_reach_85_pred'] / max_reach
                            ...
                            df_append_sim.loc[count, 'rf_reach_pct_90_pred'] = df_append_sim.loc[count, 'rf_reach_90_pred'] / max_reach
                            ...
                            df_append_sim.loc[count, 'rf_reach_pct_95_pred'] = df_append_sim.loc[count, 'rf_reach_95_pred'] / max_reach
                            ...
                            df_append_sim.loc[count, 'rf_reach_pct_100_pred'] = df_append_sim.loc[count, 'rf_reach_100_pred'] / max_reach
                            ...
                            df_append_sim.loc[count, 'rf_reach_pct_105_pred'] = df_append_sim.loc[count, 'rf_reach_105_pred'] / max_reach
                            ...
                            df_append_sim.loc[count, 'rf_reach_pct_110_pred'] = df_append_sim.loc[count, 'rf_reach_110_pred'] / max_reach
                            ...
                            df_append_sim.loc[count, 'rf_reach_pct_115_pred'] = df_append_sim.loc[count, 'rf_reach_115_pred'] / max_reach
                            ...
                            df_append_sim.loc[count, 'rf_reach_pct_120_pred'] = df_append_sim.loc[count, 'rf_reach_120_pred'] / max_reach
                            ...
                            df_append_sim.loc[count, 'rf_reach_pct_125_pred'] = df_append_sim.loc[count, 'rf_reach_125_pred'] / max_reach
                            ...
                            df_append_sim.loc[count, 'rf_reach_pct_130_pred'] = df_append_sim.loc[count, 'rf_reach_130_pred'] / max_reach
                            ...
                            df_append_sim.loc[count, 'rf_reach_pct_135_pred'] = df_append_sim.loc[count, 'rf_reach_135_pred'] / max_reach
                            ...
                            df_append_sim.loc[count, 'rf_reach_pct_140_pred'] = df_append_sim.loc[count, 'rf_reach_140_pred'] / max_reach
                            ...
                            df_append_sim.loc[count, 'rf_reach_pct_145_pred'] = df_append_sim.loc[count, 'rf_reach_145_pred'] / max_reach
                            ...
                            df_append_sim.loc[count, 'rf_reach_pct_150_pred'] = df_append_sim.loc[count, 'rf_reach_150_pred'] / max_reach
                            ...
                            df_append_sim.loc[count, 'rf_reach_pct_155_pred'] = df_append_sim.loc[count, 'rf_reach_155_pred'] / max_reach
                            ...
                            df_append_sim.loc[count, 'rf_reach_pct_160_pred'] = df_append_sim.loc[count, 'rf_reach_160_pred'] / max_reach
                            ...
                            df_append_sim.loc[count, 'rf_reach_pct_165_pred'] = df_append_sim.loc[count, 'rf_reach_165_pred'] / max_reach
                            ...
                            df_append_sim.loc[count, 'rf_reach_pct_170_pred'] = df_append_sim.loc[count, 'rf_reach_170_pred'] / max_reach
                            ...
                            df_append_sim.loc[count, 'rf_reach_pct_175_pred'] = df_append_sim.loc[count, 'rf_reach_175_pred'] / max_reach
                            ...
                            df_append_sim.loc[count, 'rf_reach_pct_180_pred'] = df_append_sim.loc[count, 'rf_reach_180_pred'] / max_reach
                            ...
                            df_append_sim.loc[count, 'rf_reach_pct_185_pred'] = df_append_sim.loc[count, 'rf_reach_185_pred'] / max_reach
                            ...
                            df_append_sim.loc[count, 'rf_reach_pct_190_pred'] = df_append_sim.loc[count, 'rf_reach_190_pred'] / max_reach
                            ...
                            df_append_sim.loc[count, 'rf_reach_pct_195_pred'] = df_append_sim.loc[count, 'rf_reach_195_pred'] / max_reach
                            ...
                            df_append_sim.loc[count, 'rf_reach_pct_200_pred'] = df_append_sim.loc[count, 'rf_reach_200_pred'] / max_reach
                            ...
                            df_append_sim.loc[count, 'rf_reach_pct_210_pred'] = df_append_sim.loc[count, 'rf_reach_210_pred'] / max_reach
                            ...
                            df_append_sim.loc[count, 'rf_reach_pct_220_pred'] = df_append_sim.loc[count, 'rf_reach_220_pred'] / max_reach
                            ...
                            df_append_sim.loc[count, 'rf_reach_pct_230_pred'] = df_append_sim.loc[count, 'rf_reach_230_pred'] / max_reach
                            ...
                            df_append_sim.loc[count, 'rf_reach_pct_240_pred'] = df_append_sim.loc[count, 'rf_reach_240_pred'] / max_reach
                            ...
                            df_append_sim.loc[count, 'rf_reach_pct_250_pred'] = df_append_sim.loc[count, 'rf_reach_250_pred'] / max_reach
                            ...
                            df_append_sim.loc[count, 'rf_reach_pct_260_pred'] = df_append_sim.loc[count, 'rf_reach_260_pred'] / max_reach
                            ...
                            df_append_sim.loc[count, 'rf_reach_pct_270_pred'] = df_append_sim.loc[count, 'rf_reach_270_pred'] / max_reach
                            ...
                            df_append_sim.loc[count, 'rf_reach_pct_280_pred'] = df_append_sim.loc[count, 'rf_reach_280_pred'] / max_reach
                            ...
                            df_append_sim.loc[count, 'rf_reach_pct_290_pred'] = df_append_sim.loc[count, 'rf_reach_290_pred'] / max_reach
                            ...
                            df_append_sim.loc[count, 'closest_lower_conversion_300'] = closest_lower_row_300.loc[0, 'conversion']
                            ...
                            df_append_sim.loc[count, 'rf_reach_pct_300_pred'] = df_append_sim.loc[count, 'rf_reach_300_pred'] / max_reach
    ...
    df_budget = pd.melt(df_append_sim, id_vars = ['country','gender','age_min','age_max', 'days', 'weekly_freq_cap', 'objective', 'interests'],
    ...
    df_impressions = pd.melt(df_append_sim, id_vars = ['country','gender','age_min','age_max', 'days', 'weekly_freq_cap', 'objective', 'interests'],
    ...
    df_reach = pd.melt(df_append_sim, id_vars = ['country','gender','age_min','age_max', 'days', 'weekly_freq_cap', 'objective', 'interests'],
    ...
    df_frequency = pd.melt(df_append_sim, id_vars = ['country','gender','age_min','age_max', 'days', 'weekly_freq_cap', 'objective', 'interests'],
    ...
    df_weekly_freq = pd.melt(df_append_sim, id_vars = ['country','gender','age_min','age_max', 'days', 'weekly_freq_cap', 'objective', 'interests'],
    ...
    df_cpm = pd.melt(df_append_sim, id_vars = ['country','gender','age_min','age_max', 'days', 'weekly_freq_cap', 'objective', 'interests'],
    ...
    df_melt_clean = df_melt[['country','gender','age_min','age_max','days','weekly_freq_cap','objective','interests',
                             'Scenario_budget','Budget','Impressions','Reach','Frequency','Weekly frequency','CPM']]

    # Rename columns to have an easier reading
    df_melt_clean = df_melt_clean.rename(columns = {
        'country': 'Country','gender': 'Gender','age_min': 'Age min','age_max': 'Age max','days': 'Campaign days',
        'weekly_freq_cap': 'Weekly frequency cap','objective': 'Campaign objective','interests': 'Interests list',
