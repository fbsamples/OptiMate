...
for objective in objectives_list:
    ...
    if objective == 'POST_ENGAGEMENT':
            ...
            params={
                ...
                'target_spec': {
                   ...
                   'flexible_spec': inc_inter_behav,
                    ...
                    # IMPORTANT: For POST_ENGAGEMENT, 'audience_network' cannot be used as the only platform,
        ...
        # Create some other fields that are relevant when analzing reach and frequency curves
        ...
        # Create a list to store the minimum and maximim budget for each objective    
        ...
        prediction = ad_account.create_reach_frequency_prediction(
            params={
                ...
                'target_spec': {
                    ...
                    # IMPORTANT: For LINK_CLICKS in Reach&Frequency buying type, 'audience_network' cannot be used
                    'publisher_platforms': [
                        'facebook',
                        'instagram',
                    ],
            ...
            params={
                ...
                'target_spec': {
                   ...
                   'flexible_spec': inc_inter_behav,
                    ...
                    # IMPORTANT: For REACH, 'audience_network' cannot be used as the only platform,
                    # it needs to be used with at least facebook-feed OR instagram-stream
                    'publisher_platforms': [
                        'facebook',
                        'instagram',
        ...
        prediction = ad_account.create_reach_frequency_prediction(
            params={
                ...
                'target_spec': {
                    ...
                    # IMPORTANT: For BRAND_AWARENESS, 'audience_network' cannot be used as the only platform,
                    # it needs to be used with at least facebook-feed OR instagram-stream
                    'publisher_platforms': [
                        'facebook',
                        'instagram',
...
fig, ax = plt.subplots()
ax.plot(pivot_interpolated['budget_']/1000, pivot_interpolated['reach_REACH']/1000000, label = 'Reach', color = '#8dd3c7')
ax.plot(pivot_interpolated['budget_']/1000, pivot_interpolated['reach_BRAND_AWARENESS']/1000000, label = 'Brand Awareness', color = '#fdb462')
ax.plot(pivot_interpolated['budget_']/1000, pivot_interpolated['reach_LINK_CLICKS']/1000000, label = 'Link Clicks', color = '#80b1d3')
ax.plot(pivot_interpolated['budget_']/1000, pivot_interpolated['reach_POST_ENGAGEMENT']/1000000, label = 'Post Engagement', color = '#b3de69')
ax.plot(pivot_interpolated['budget_']/1000, pivot_interpolated['reach_VIDEO_VIEWS']/1000000, label = 'Video Views', color = '#fb8072')
leg = ax.legend()
...
fig, bx = plt.subplots()
bx.plot(pivot_interpolated['budget_']/1000, pivot_interpolated['frequency_REACH'], label = 'Reach', color = '#8dd3c7')
bx.plot(pivot_interpolated['budget_']/1000, pivot_interpolated['frequency_BRAND_AWARENESS'], label = 'Brand Awareness', color = '#fdb462')
bx.plot(pivot_interpolated['budget_']/1000, pivot_interpolated['frequency_LINK_CLICKS'], label = 'Link Clicks', color = '#80b1d3')
bx.plot(pivot_interpolated['budget_']/1000, pivot_interpolated['frequency_POST_ENGAGEMENT'], label = 'Post Engagement', color = '#b3de69')
bx.plot(pivot_interpolated['budget_']/1000, pivot_interpolated['frequency_VIDEO_VIEWS'], label = 'Video Views', color = '#fb8072')
leg = bx.legend()
plt.xlabel('Budget '+ str(acc_currency) +' (Thousands)')
...
fig, cx = plt.subplots()
cx.plot(pivot_interpolated['budget_']/1000, pivot_interpolated['cpm_REACH'], label = 'Reach', color = '#8dd3c7')
cx.plot(pivot_interpolated['budget_']/1000, pivot_interpolated['cpm_BRAND_AWARENESS'], label = 'Brand Awareness', color = '#fdb462')
cx.plot(pivot_interpolated['budget_']/1000, pivot_interpolated['cpm_LINK_CLICKS'], label = 'Link Clicks', color = '#80b1d3')
cx.plot(pivot_interpolated['budget_']/1000, pivot_interpolated['cpm_POST_ENGAGEMENT'], label = 'Post Engagement', color = '#b3de69')
cx.plot(pivot_interpolated['budget_']/1000, pivot_interpolated['cpm_VIDEO_VIEWS'], label = 'Video Views', color = '#fb8072')
leg = cx.legend()
plt.xlabel('Budget '+ str(acc_currency) +' (Thousands)')
...
fig, dx = plt.subplots()
dx.plot(pivot_interpolated['budget_']/1000, pivot_interpolated['weekly_frequency_REACH'], label = 'Reach', color = '#8dd3c7')
dx.plot(pivot_interpolated['budget_']/1000, pivot_interpolated['weekly_frequency_BRAND_AWARENESS'], label = 'Brand Awareness', color = '#fdb462')
dx.plot(pivot_interpolated['budget_']/1000, pivot_interpolated['weekly_frequency_LINK_CLICKS'], label = 'Link Clicks', color = '#80b1d3')
dx.plot(pivot_interpolated['budget_']/1000, pivot_interpolated['weekly_frequency_POST_ENGAGEMENT'], label = 'Post Engagement', color = '#b3de69')
dx.plot(pivot_interpolated['budget_']/1000, pivot_interpolated['weekly_frequency_VIDEO_VIEWS'], label = 'Video Views', color = '#fb8072')
leg = dx.legend()
plt.xlabel('Budget '+ str(acc_currency) +' (Thousands)')
...
# Plot the Reach and Frequency Curves for Weekly frequency
fig, ex = plt.subplots()
ex.plot(pivot_interpolated['budget_']/1000, (pivot_interpolated['audience_pct_lower_bound_REACH'] * 100), label = 'Reach', color = '#8dd3c7')
ex.plot(pivot_interpolated['budget_']/1000, (pivot_interpolated['audience_pct_lower_bound_BRAND_AWARENESS'] * 100), label = 'Brand Awareness', color = '#fdb462')
ex.plot(pivot_interpolated['budget_']/1000, (pivot_interpolated['audience_pct_lower_bound_LINK_CLICKS'] * 100), label = 'Link Clicks', color = '#80b1d3')
ex.plot(pivot_interpolated['budget_']/1000, (pivot_interpolated['audience_pct_lower_bound_POST_ENGAGEMENT'] * 100), label = 'Post Engagement', color = '#b3de69')
ex.plot(pivot_interpolated['budget_']/1000, (pivot_interpolated['audience_pct_lower_bound_VIDEO_VIEWS'] * 100), label = 'Video Views', color = '#fb8072')
leg = ex.legend()
plt.xlabel('Budget '+ str(acc_currency) +' (Thousands)')
...
# Save the pdf in the save_directory
plt.savefig(r'' + save_directory + '01_Lower_Bound_Reach_PCT_' + str(acc_id) + '_' + datetime.today().strftime('%Y-%m-%d') + '.pdf')

# Plot the Reach and Frequency Curves for Weekly frequency
fig, fx = plt.subplots()
fx.plot(pivot_interpolated['budget_']/1000, (pivot_interpolated['audience_pct_upper_bound_REACH'] * 100), label = 'Reach', color = '#8dd3c7')
fx.plot(pivot_interpolated['budget_']/1000, (pivot_interpolated['audience_pct_upper_bound_BRAND_AWARENESS'] * 100), label = 'Brand Awareness', color = '#fdb462')
fx.plot(pivot_interpolated['budget_']/1000, (pivot_interpolated['audience_pct_upper_bound_LINK_CLICKS'] * 100), label = 'Link Clicks', color = '#80b1d3')
fx.plot(pivot_interpolated['budget_']/1000, (pivot_interpolated['audience_pct_upper_bound_POST_ENGAGEMENT'] * 100), label = 'Post Engagement', color = '#b3de69')
fx.plot(pivot_interpolated['budget_']/1000, (pivot_interpolated['audience_pct_upper_bound_VIDEO_VIEWS'] * 100), label = 'Video Views', color = '#fb8072')
leg = fx.legend()
plt.xlabel('Budget '+ str(acc_currency) +' (Thousands)')
...
# Save the pdf in the save_directory
plt.savefig(r'' + save_directory + '01_Upper_Bound_Reach_PCT_' + str(acc_id) + '_' + datetime.today().strftime('%Y-%m-%d') + '.pdf')
